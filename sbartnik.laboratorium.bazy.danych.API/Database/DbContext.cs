...
namespace sbartnik.laboratorium.bazy.danych.Database
{
	public class ApplicationDbContext : DbContext
	{
		...
		protected override void OnConfiguring(DbContextOptionsBuilder options)
			=> options.UseSqlServer(@"Data Source=.;Database=cars;Persist Security Info=True;User ID=sa;Password=Gu74ch73nDB;Pooling=False;MultipleActiveResultSets=False;Connect Timeout=60;Encrypt=False;TrustServerCertificate=False");
